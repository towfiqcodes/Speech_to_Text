package com.rit.speechtotextapplication;
        ...
        switch (requestCode){
            case REQ_CODE_VOICE_INPUT:
                if(resultCode==RESULT_OK && null !=data){
                    ArrayList<String> rresult=data.getStringArrayListExtra( RecognizerIntent.EXTRA_RESULTS );
                    voiceInput.setText( rresult.get(0) );
                }
        }
    }
}
